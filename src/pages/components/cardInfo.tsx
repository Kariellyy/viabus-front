...
export default function CardInfo({ title, value, icon: Icon, color }: CardProps) {
  return (
    <div className="col-md-4">
      <div className={`card rounded-3 border-0 ${styles.card1} position-relative`} style={{'--card-color': color} as React.CSSProperties}>
        <div className={styles.iconWrapper}> 
          <span className={`${styles.iconSize} text-white`}><Icon /></span>
        </div>
